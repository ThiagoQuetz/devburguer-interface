...
import { Container, Form, InputGroup, Label, Input, LabelUpload, ContainerCheckbox,Select, SubmitButton, ErrorMessage } from './styles'
...
const schema = yup.object({
    ...
    price: yup.number().positive().required('Digite o price do produto').typeError('Digite o preço do produto'),
